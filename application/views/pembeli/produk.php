...
<div class="container-fluid pt-3 mt-4 mb-5">
    ...
    <div class="row justify-content-center mx-auto">
        <?php foreach ($produkpagination as $produk) : ?>
        <div class="card mx-3 mb-4 shadow-sm" style="width: 18rem; border: none;">
            <a href="" data-toggle="modal" data-target="#detail<?= $produk['idProduk']?>"><img src="<?= base_url('assets/img/produk/') . $produk['gambar']; ?>" style="padding:30px; object-fit: cover; height: 258px;" class="card-img-top"></a>
            <small class="text-center text-muted">Klik gambar untuk detail produk.</small>
            <div class="card-body text-center text-capitalize">
                <h5 class="card-title"><b><?= $produk['nama']; ?></b></h5>
                <h6 class="mt-n2 mb-3"><small class="text-secondary"><?= $produk['namaJenis']; ?></small></h6>
 ...
 <div class="modal-dialog" role="document">
  <div class="modal-content">
   ...
   <div class="modal-footer">
                <a href="<?= base_url('customer/addtocart/').$produk['idProduk']; ?>" class="btn btn-outline-info mr-1"><i class="fas fa-lg fa-cart-plus ml-n1 mr-1"></i> Tambah ke Keranjang</a>
