<div class="col pt-3 mb-4">
	<div class="container mt-5">
		...
		<div class="mt-4 row">
            ...
            <form action="<?= base_url('produk'); ?>" method="post" class="col-4 justify-content-end">
						...
						<form action="">
                            ...
                            <td width="1">
                                <span data-toggle="tooltip" data-placement="left" title="Edit">
                                    <a href="<?= base_url(); ?>produk/editproduk/<?= $o['idProduk']?>">
                            ...
                            <?php if ($o['status'] == 1) : ?>
                                <td width="1">
                                    <span data-toggle="tooltip" data-placement="left" title="Hapus">
                                        <a href="<?= base_url(); ?>produk/hapusProduk/<?= $o['idProduk']?>"
