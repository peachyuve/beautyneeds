    ...
    <div class="container mt-5">
        ...
        <div class="mt-4 row">
            <div class="col justify-content-start">
                <a href="<?= base_url(); ?>sales/tambahproduk">
                    <button class="btn btn-success">
                        <i class="fas fa-fw fa-plus mr-2"></i>Tambah Produk
                    </button>
                </a>
            </div>
            <form action="<?= base_url('sales/produk'); ?>" method="post" class="col-4 justify-content-end">
...
<!--                             <td><?= $o['gambar']?></td>
                            ...
                            <td width="1">
                                <span data-toggle="tooltip" data-placement="left" title="Edit">
                                    <a href="<?= base_url(); ?>sales/editproduk/<?= $o['idProduk']?>">
                            ...
                            <?php if ($o['status'] == 1) : ?>
                                <td width="1">
                                    <span data-toggle="tooltip" data-placement="left" title="Hapus">
                                        <a href="<?= base_url(); ?>sales/hapusProduk/<?= $o['idProduk']?>"
...
<?php if ( empty($produkpagination) == FALSE) :?>
